#!/usr/bin/env bash
# Testa o parser Python com os casos .c e compara a saída com o
# resultado esperado.
# Uso: ./testar_parser_py_oficial.sh [diretorio_dos_testes] [script_do_parser]
# Exemplo: ./testar_parser_py_oficial.sh ./testes-parser-50 ./parser.py
set -u
TEST_DIR="${1:-.}"
PARSER="${2:-./parser.py}"
KEEP_TMP="${KEEP_TMP:-0}"
